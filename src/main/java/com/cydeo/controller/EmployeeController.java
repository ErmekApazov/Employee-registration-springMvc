...
public class EmployeeController {
    ...
    @PostMapping("/insert")
    public String insertEmployee(@ModelAttribute("employee")
                                     @Valid Employee employee, BindingResult bindingResult, Model model) {
        // this block of code is for checking any error that might occur in employee object
        // if there are error intelliJ will go inside this block
        // and will return the same page, so Programmer won't go further but stay in the same page until error is corrected.
